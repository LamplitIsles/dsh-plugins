...
corepack pnpm --filter @lamplitisles/kepos-speech run typecheck
corepack pnpm --filter @lamplitisles/kepos-speech run test
corepack pnpm --filter @lamplitisles/kepos-speech run build
DSH_CLI=/absolute/path/to/dsh corepack pnpm --filter @lamplitisles/kepos-speech run pack-smoke
```
...
DSH_CLI=/absolute/path/to/dsh corepack pnpm run release:prepare -- \
  @lamplitisles/kepos-speech v0.1.0 .release-artifacts/kepos-speech
```
...
```sh
npm publish .release-artifacts/kepos-speech/lamplitisles-kepos-speech-0.1.0.tgz \
