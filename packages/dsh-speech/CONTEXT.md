...
This glossary describes the ownership and boundaries of DSH Speech's browser
...
**Host Speech service**:
The optional in-process Cordis service named `dshSpeech`. A Host
...
`.dsh/dsh-speech/audio/<sha256>.mp3`. Browser and Host synthesis share this
...
`DSH_SPEECH_DASHSCOPE_API_KEY`, used by Alibaba TTS and the fixed
